...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/admin/ueditor/index?origin={{ $origin }}&action=uploadfile',
            // runtimeOrder: 'flash',

            accept: {
            //     title: 'Images',
                extensions: '{{ config('system.file_type') }}',
            //     mimeTypes: 'image/*'
            },
            ...
            fileNumLimit: 1,
            fileSizeLimit: {{ config('system.file_size') }} * 1024 * 1024,    // 200 M
        ...
        uploader.on('uploadSuccess', function (file, json) {
            ...
            try {
                ...
                if (json.state == 'SUCCESS') {
                	...
                	$('#{{ $id }}', parent.document).val(json.url);
            ...
            if ( state === 'ready' ) {
                ...
                if ( stats.uploadFailNum ) {
                    text = '已成功上传' + stats.successNum+ '份文件，'+
                        stats.uploadFailNum + '份上传失败，<a class="retry" href="#">重新上传</a>失败文件或<a class="ignore" href="#">忽略</a>'
                }
