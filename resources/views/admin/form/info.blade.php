...
<div class="x-body">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			<label for="sequence" class="layui-form-label form-label-medium">表单顺序</label>
			<div class="layui-input-inline input-large">
		...
		<div class="layui-form-item">
			<label for="sort" class="layui-form-label form-label-medium">内容排序</label>
			<div class="layui-input-inline input-large">
		...
		<div class="layui-form-item">
			<label for="display" class="layui-form-label form-label-medium">前台表单</label>
			<div class="layui-input-inline input-large">
		...
		<div id="reception" @if(isset($info) && $info->display == 0)style="display: none;" @endif>
			<div class="layui-form-item">
    			<label for="return_type" class="layui-form-label form-label-medium">前台提交返回</label>
    			<div class="layui-input-inline input-large">
    		...
    		<div class="layui-form-item">
    			<label for="return_msg" class="layui-form-label form-label-medium">提交成功后消息</label>
    			<div class="layui-input-inline input-large">
    		...
    		<div class="layui-form-item">
    			<label for="return_url" class="layui-form-label form-label-medium">成功后返回地址</label>
    			<div class="layui-input-inline input-large">
    		...
    		<div class="layui-form-item">
    			...
    			<div class="layui-input-inline input-large">
    				<input type="text" id="page1" name="page" value="@isset($info){{ $info->page }}@else{{ '10' }}@endisset" autocomplete="off" class="layui-input">
    			</div>
    			<div class="layui-form-mid layui-word-aux">前台列表显示的分页数</div>
    		</div>
    		<div class="layui-form-item">
    			<label for="condition" class="layui-form-label form-label-medium">前台列表条件</label>
    			<div class="layui-input-inline input-large">
    		...
    		<div class="layui-form-item">
    			<label for="tpl" class="layui-form-label form-label-medium">前台模板</label>
    			<div class="layui-input-inline input-large">
    		...
    		<div class="layui-form-item">
    			<label for="is_captcha" class="layui-form-label form-label-medium">图片验证码	</label>
    			<div class="layui-input-inline input-large">
    				<input type="checkbox" id="is_captcha" name="is_captcha" value="1" lay-skin="switch" lay-text="ON|OFF" @if(!isset($info) || $info->is_captcha==1)checked @endisset>
    			</div>
    		</div>
		</div>
		<div class="layui-form-item">
