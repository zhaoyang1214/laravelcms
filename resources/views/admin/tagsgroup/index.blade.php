		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a class="layui-btn layui-btn-normal layui-btn-xs" onclick="x_admin_show('查看表单','/admin/tagsgroup/info/{{ $data->id }}', 850)"><i class="layui-icon layui-icon-edit"></i>查看</a>
					@endif
...
layui.use(['laypage', 'layer', 'jquery'], function(){
	  ...
	  laypage.render({
	    ...
	    jump: function(obj, first){
	        if(!first) {
	        	layer.load();
	        	location.href = "/admin/tagsgroup/index?page=" + obj.curr;
	        }
	        if(obj.count == 0) {
				$("#page").hide();
	        }
	  ...
	  $(".del").click(function(){
		  ...
		  layer.confirm('确认要删除该tag组吗？',function(index){
			  $.ajax({
	  			type:'post',
	  			url:'/admin/tagsgroup/delete',
